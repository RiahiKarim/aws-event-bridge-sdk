        ...
        AWS.EventListeners = {
            Core: new SequentialExecutor().addNamedListeners(function(add, addAsync) {
                ...
                add("COMPUTE_CHECKSUM", "afterBuild", function COMPUTE_CHECKSUM(req) {
                    ...
                    if (operation.httpChecksumRequired && req.service.config.computeChecksums && isNonStreamingPayload && req.service.getSignerClass(req) === AWS.Signers.V4 && !headers["Content-MD5"]) {
...
}, {}, [ 28 ]);AWS.apiLoader.services["eventbridge"] = {};

AWS.EventBridge = AWS.Service.defineService("eventbridge", [ "2015-10-07" ]);AWS.apiLoader.services["eventbridge"]["2015-10-07"] = {
    version: "2.0",
    metadata: {
...
}, {}, [ 114 ]);AWS.apiLoader.services["sts"]["2011-06-15"] = {
    version: "2.0",
    metadata: {
